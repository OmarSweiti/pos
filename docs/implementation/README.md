...
Phase 1 has **26 of 112 executable microsteps fully complete (~23%)**: `1.1.0`
...
search box before a burst can be recognised taken back out of it), and `1.11.11` (the keyboard map —
every action in `ref/ui-spec.md` §7 reachable without a mouse, with the keys that mean something
inside a text box yielding to one that has focus).
<!-- frontier:end -->
